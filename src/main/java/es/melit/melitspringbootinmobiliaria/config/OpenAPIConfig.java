...
public class OpenAPIConfig {
  ...
  @Value("${inmobiliaria.openapi.dev-url}")
  private String devUrl;

  @Value("${inmobiliaria.openapi.prod-url}")
  ...
  public OpenAPI myOpenAPI() {
    ...
    contact.setEmail("info@melit.es");
    contact.setName("MELIT");
    contact.setUrl("https://www.melit.es/");
